...
function WakeupGenie() {
    ...
    var buf ='<input id="tglGenie" type="button" onclick="showHideGenie()" style="z-index:110;position:absolute;top:0px;left:0px;width: 9px;height: 26px;background-color:#4040ff;padding-left: 0px;padding-right: 0px;border-left-width: 1px;border-right-width: 1px;border-bottom-width: 1px;border-top-width: 1px;padding-top: 2px;">'
			+ '<input id="genie" style="z-index:-110; position:absolute; left:8px;top:-1px;width:100%; height:20px; color:#404040; background-color:#efefff"></input>';
    el.innerHTML = buf;
